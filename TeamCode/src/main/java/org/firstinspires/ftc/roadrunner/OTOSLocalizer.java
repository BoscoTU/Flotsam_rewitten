...
public class OTOSLocalizer implements Localizer {
    public static class Params {
        public double angularScalar = 0.9932;
        public double linearScalar = 0.9955085865257596;

        // Note: units are in inches and radians
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-2.9375, -1.9375, 0);
    }
