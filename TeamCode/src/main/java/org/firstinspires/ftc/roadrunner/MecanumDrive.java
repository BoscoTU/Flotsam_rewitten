...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public DcMotorSimple.Direction REAR_LEFT_MOTOR_DRIECTION = DcMotor.Direction.REVERSE;
        public DcMotorSimple.Direction FRONT_RIGHT_MOTOR_DRIECTION = DcMotor.Direction.FORWARD;
        public DcMotorSimple.Direction REAR_RIGHT_MOTOR_DRIECTION = DcMotor.Direction.FORWARD;
...
//        public double inPerTick = 0.00106;
        ...
        public  double kS = 2.280539637886016;
//        public double kS = 0.39;
//        TODO: three dead wheel localizer
//        public double kV = 0.00021;
        public double kV = -3.1903959751948747;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            ...
            leftFront.setDirection(PARAMS.FRONT_LEFT_MOTOR_DRIECTION);
            leftBack.setDirection(PARAMS.REAR_LEFT_MOTOR_DRIECTION);
            rightBack.setDirection(PARAMS.REAR_RIGHT_MOTOR_DRIECTION);
            rightFront.setDirection(PARAMS.FRONT_RIGHT_MOTOR_DRIECTION);
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, this.PARAMS.FRONT_LEFT_MOTOR_NAME);
        leftBack = hardwareMap.get(DcMotorEx.class, this.PARAMS.REAR_LEFT_MOTOR_NAME);
...
//        );
        ...
        leftBack.setDirection(this.PARAMS.REAR_LEFT_MOTOR_DRIECTION);
        rightBack.setDirection(this.PARAMS.REAR_RIGHT_MOTOR_DRIECTION);
        rightFront.setDirection(this.PARAMS.FRONT_RIGHT_MOTOR_DRIECTION);
